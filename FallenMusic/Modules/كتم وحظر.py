...
from FallenMusic.utils.database import set_loop
from FallenMusic.utils.decorators import AdminRightsCheck
from datetime import datetime
from config import BANNED_USERS, PING_IMG, lyrical, START_IMG, OWNER_ID
...
from FallenMusic.utils.database import (set_cmode,get_assistant) 
from FallenMusic.utils.decorators.admins import AdminActual
from FallenMusic import app
...
muttof = []
@app.on_message(filters.command(["قفل التقيد", "تعطيل التقيد", "تعطيل الحمايه"], ""), group=419)
...
@app.on_message(filters.command(["فتح التقيد", "تفعيل التقيد", "تفعيل الحمايه"], ""), group=424)
...
@app.on_message(filters.command(["الغاء تقيد","الغاء لتقيد"], ""), group=94) 
...
gaaof = []
@app.on_message(filters.command(["تعطيل الحظر", "تعطيل الطرد", "تعطيل الحمايه"], ""), group=504)
...
@app.on_message(filters.command(["فتح الطرد", "تفعيل الطرد", "تفعيل الحظر", "تفعيل الحمايه"], ""), group=412)
...
banned_users = []
@app.on_message(filters.command(["حظر", "طرد"], ""), group=39)
async def mute(client: Client, message: Message):
    global banned_users    
